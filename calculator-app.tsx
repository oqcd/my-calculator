...
const Calculator = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 flex items-center justify-center p-4">
      <div className="bg-black/30 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/10 p-6 w-full max-w-sm">
        ...
        <div className="text-center mt-6">
          <p className="text-white/60 text-sm">Calculator App</p>
        </div>
      </div>
    </div>
  );
